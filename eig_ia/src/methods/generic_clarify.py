...
def run_generic_clarify(dataset: str, example: Dict[str, Any], llm_q, llm_a, llm_scorer, mode: str) -> Dict[str, Any]:
    ...
    questions, q_meta = generate_questions(dataset, observation, hypotheses, llm_q, 1)
